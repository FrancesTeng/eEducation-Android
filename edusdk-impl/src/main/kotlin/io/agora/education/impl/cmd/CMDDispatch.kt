...
internal class CMDDispatch(private val eduRoom: EduRoom) {
    ...
    private var cmdCallbackManager: CMDCallbackManager = CMDCallbackManager(
            (eduRoom as EduRoomImpl).dataCache)
    ...
    fun dispatchChannelMsg(text: String, eventListener: EduRoomEventListener?) {
...
//                        }
                    ...
                    CMDStreamAction.Modify.value -> {
                        ...
                        if (eduRoom.joinSuccess) {
                            ...
                            eduRoom.dataCache.addModifiedStreams(validModifyStreams)
                        }
                    }
...
//                        }
    ...
    fun dispatchPeerMsg(text: String, eventListener: EduRoomEventListener?) {
        val cmdResponseBody = Gson().fromJson<CMDResponseBody<Any>>(text, object :
